...
res = pd.read_csv(readfile,
                  names=['ANGSEP','A_IMAGE','B_IMAGE','CCDNUM','CLASS_STAR_g','CLASS_STAR_i','CLASS_STAR_r','CLASS_STAR_z',
                  'CXX_IMAGE','CXY_IMAGE','CYY_IMAGE','DLR','DLR_RANK','EDGE_FLAG','ELONGATION','FIELD',
                  'FLUXERR_APER_g','FLUXERR_APER_i','FLUXERR_APER_r','FLUXERR_APER_z',
                  'FLUXERR_AUTO_g','FLUXERR_AUTO_i','FLUXERR_AUTO_r','FLUXERR_AUTO_z',
                  'FLUX_APER_g','FLUX_APER_i','FLUX_APER_r','FLUX_APER_z',
                  'FLUX_AUTO_g','FLUX_AUTO_i','FLUX_AUTO_r','FLUX_AUTO_z',
                  'FLUX_RADIUS_g','FLUX_RADIUS_i','FLUX_RADIUS_r','FLUX_RADIUS_z',
                  'FWHM_WORLD_g','FWHM_WORLD_i','FWHM_WORLD_r','FWHM_WORLD_z',
                  'KRON_RADIUS','LIMFLUX_g','LIMFLUX_i','LIMFLUX_r','LIMFLUX_z',
                  'LIMMAG_g','LIMMAG_i','LIMMAG_r','LIMMAG_z',
                  'MAGERR_APER_g','MAGERR_APER_i','MAGERR_APER_r','MAGERR_APER_z',
                  'MAGERR_AUTO_g','MAGERR_AUTO_i','MAGERR_AUTO_r','MAGERR_AUTO_z',
                  'MAGERR_STATSYST_APER_g','MAGERR_STATSYST_APER_i','MAGERR_STATSYST_APER_r','MAGERR_STATSYST_APER_z',
                  'MAGERR_STATSYST_AUTO_g','MAGERR_STATSYST_AUTO_i','MAGERR_STATSYST_AUTO_r','MAGERR_STATSYST_AUTO_z',
                  'MAGERR_SYST_APER_g','MAGERR_SYST_APER_i','MAGERR_SYST_APER_r','MAGERR_SYST_APER_z',
                  'MAGERR_SYST_AUTO_g','MAGERR_SYST_AUTO_i','MAGERR_SYST_AUTO_r','MAGERR_SYST_AUTO_z',
                  'MAG_APER_g','MAG_APER_i','MAG_APER_r','MAG_APER_z','MAG_AUTO_g','MAG_AUTO_i','MAG_AUTO_r','MAG_AUTO_z',
                  'MAG_ZEROPOINT_ERR_g','MAG_ZEROPOINT_ERR_i','MAG_ZEROPOINT_ERR_r','MAG_ZEROPOINT_ERR_z',
                  'MAG_ZEROPOINT_g','MAG_ZEROPOINT_i','MAG_ZEROPOINT_r','MAG_ZEROPOINT_z','MY','PHOTOZ',
                  'PHOTOZ_ERR','SNID','THETA_IMAGE','X_IMAGE','X_WORLD','Y_IMAGE','Y_WORLD','Z_RANK',
                  'ez','flag','objtype_ozdes','source','transtype_ozdes','z'])
